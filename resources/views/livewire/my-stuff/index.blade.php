<div class="flex min-h-screen flex-col bg-blue-100" x-data="cartComponent()" x-init="init()">
    ...
    <div class="grid grid-cols-1 gap-4 p-1 md:grid-cols-2 lg:grid-cols-3">
      @foreach ($this->items as $item)
        <div class="min-h-40 relative rounded-lg bg-white px-4 py-2 shadow-md">
          ...
          <p class="text-gray-700">{{ $item->model_number }}</p>
    ...
    function cartComponent() {
      return {
        ...
        addToCart(id) {
          ...
          if (this.cart[id].quantity < item.my_stock) {
