<div class="flex min-h-screen items-center justify-center">
  <div class="max-w-96 fixed top-56 z-20 mx-auto w-11/12 rounded-lg bg-white p-1 md:top-44">
    <div class="flex justify-between p-1">
      <div class="text-xl font-bold"> 返却カート</div>
    ...
    <div class="mt-2 max-h-96 overflow-y-auto p-1 text-gray-800">
      ...
      <template x-if="Object.keys(cart).length > 0">
        <div class="absolute bottom-2 right-2 mt-4 flex justify-end bg-white">
          <button class="flex items-center rounded bg-teal-600 px-4 py-2 text-xl font-bold text-white"
            @click="giveBack">
